...
public class LinkedListDriver {
  public static void main(String[] args) {     
    ...
    insertBefore(stringList, "Dammam", "Tabouk"); // Task 1.
    ...
    insertBeforeLast(stringList, "Alkhafj"); // Task 2.
    System.out.println("Task 2: " + stringList);
  ...
  // ---------------------------------
  // Task 1
  public static void insertBefore(LinkedList<String> list, String oldObject, String newObject){
    int index = list.indexOf(oldObject);
    if(index == -1)
      System.out.println(oldObject + " is not in the list");
    else{
  ...
  //----------------------------------
  // Task 2:
  public static void insertBeforeLast(LinkedList<String> list, String newObject){
    if (list.isEmpty())
      System.out.println("The list is empty.");
    else{
      list.add(list.size() - 1, newObject);
    }
  }
}
